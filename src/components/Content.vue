        ...
        >
          <ul class="nav navbar-nav ml-auto">
            <li class="nav-item">
              <a
                class="nav-link"
                href="https://github.com/DanielLimasP/tourism-info-frontend"
      ...
      <form action="#">
        ...
        <div class="row mt-2">
          <button
            type="submit"
            @click="createQuery"
            class="btn btn-info mt-4 mb-4 col-md-3 mx-auto"
          >
            Consultar
          </button>
        </div>
...
export default {
  ...
  methods: {
    async searchBarQuery() {
      ...
      let fetch_url =
        "http://localhost:420/info/query/?year=2020&wildcard=" + query_string;
    ...
    async createQuery() {
      ...
      if (
        ...
        fetch_url =
          "http://localhost:420/info/query/?year=" +
          query_year +
          "&category=" +
          query_category;
      }
