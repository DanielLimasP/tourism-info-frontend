  ...
  <div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="row container-fluid">
        <div class="col-md-2 ml-1 mr-1">
          <button type="button" id="sidebarCollapse" class="btn btn-info"><i class="fas fa-bars"></i> Ocultar</button>
    ...
    <div class="card">
      <form action="#">
        ...
        <div class="row mt-2">
          <button type="button" @click="createQuery" class="btn btn-info mt-4 mb-4 col-md-3 mx-auto">Consultar</button>
        </div>
      </form>
    </div>
...
export default {
  // ChartQuery component contains both the nav and the query form
  // in order to generate the website ChartQuery (charts or tables)
